...
export interface VerificationReceipt {
  readonly schema: "spudex-verification-receipt/v1";
  readonly repository: string;
  readonly pr: number;
...
export function createVerificationReceipt(
  ...
  const withoutDigest: Omit<VerificationReceipt, "digest"> = {
    schema: "spudex-verification-receipt/v1",
...
function parseVerificationReceipt(raw: string): VerificationReceipt {
  ...
  if (
    ...
    value.schema !== "spudex-verification-receipt/v1" ||
...
const CONSTRAINT_SCHEMA = "spudex-constraint-register/v1";

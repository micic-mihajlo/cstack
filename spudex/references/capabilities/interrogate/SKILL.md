...
Launch independent reviewers before waiting. Read [Model roles](../../model-roles.md) and any validated Spudex configuration. Prefer distinct model families. If fewer families are available, vary review roles and reasoning while keeping prompts independent. Disclose the limitation.

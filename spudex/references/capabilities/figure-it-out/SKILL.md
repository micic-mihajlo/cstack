---
name: figure-it-out
description: "Design an auditable playbook when no narrower one fits. Use for $spudex figure-it-out, a large migration, an ambitious multipart change, or work a human reviews after stepping away."
---
...
Open a todolist whose first item is to read the Principles section of the **spudex** skill. Then add the phases below as todos.

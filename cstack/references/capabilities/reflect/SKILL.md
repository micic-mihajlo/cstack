---
name: reflect
description: Review the current Codex task through judgment, tooling, and divergent lenses, then propose durable improvements to existing skills or structural checks. Use for $cstack reflect or explicit requests to capture lessons from a completed run.
---
